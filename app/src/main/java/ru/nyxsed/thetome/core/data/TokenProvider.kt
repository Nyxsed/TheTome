...
object TokenProvider {
    val Good = Token(nameResId = R.string.token_good, iconRes = R.drawable.icon_good)
    val Evil = Token(nameResId = R.string.token_evil, iconRes = R.drawable.icon_evil)

    val WasherwomanTownsfolk = Token(nameResId = R.string.token_townsfolk, iconRes = R.drawable.icon_washerwoman)
    val WasherwomanWrong = Token(nameResId = R.string.token_wrong, iconRes = R.drawable.icon_washerwoman)

    val LibrarianOutsider = Token(nameResId = R.string.token_outsider, iconRes = R.drawable.icon_librarian)
    val LibrarianWrong = Token(nameResId = R.string.token_wrong, iconRes = R.drawable.icon_librarian)

    val PoisonerPoison = Token(nameResId = R.string.token_poison, iconRes = R.drawable.icon_poisoner)

    val ImpKill = Token(nameResId = R.string.token_kill, iconRes = R.drawable.icon_imp)

    val InvestigatorWrong = Token(nameResId = R.string.token_wrong, iconRes = R.drawable.icon_investigator)
    val InvestigatorMinion = Token(nameResId = R.string.token_minion, iconRes = R.drawable.icon_investigator)

    val FortuneTellerRedHerring = Token(nameResId = R.string.token_red_herring, iconRes = R.drawable.icon_fortuneteller)

    val ButlerMaster = Token(nameResId = R.string.token_master, iconRes = R.drawable.icon_butler)

    val MonkSafe = Token(nameResId = R.string.token_safe, iconRes = R.drawable.icon_monk)

    val UndertakerDiedToday = Token(nameResId = R.string.token_died_today, iconRes = R.drawable.icon_undertaker)

    val SlayerNoAbility = Token(nameResId = R.string.token_no_ability, iconRes = R.drawable.icon_slayer)

    val VirginNoAbility = Token(nameResId = R.string.token_no_ability, iconRes = R.drawable.icon_virgin)

    val DrunkDrunk = Token(nameResId = R.string.token_drunk, iconRes = R.drawable.icon_drunk)

    val GrandmotherGrandchild = Token(nameResId = R.string.token_grandchild, iconRes = R.drawable.icon_grandmother)
    ...
    val SeamstressNoAbility = Token(nameResId = R.string.token_no_ability, iconRes = R.drawable.icon_seamstress)

    val LunaticChosen = Token(nameResId = R.string.token_chosen, iconRes = R.drawable.icon_lunatic)

    val SweetheartDrunk = Token(nameResId = R.string.token_drunk, iconRes = R.drawable.icon_sweetheart)

    val GodfatherDiedToday = Token(nameResId = R.string.token_died_today, iconRes = R.drawable.icon_godfather)
    ...
    val MinstrelEveryoneIsDrunk = Token(nameResId = R.string.token_everyone_is_drunk, iconRes = R.drawable.icon_minstrel)

    val TeaLadyCannotDie = Token(nameResId = R.string.token_cannot_die, iconRes = R.drawable.icon_tealady)

    val FoolNoAbility = Token(nameResId = R.string.token_no_ability, iconRes = R.drawable.icon_fool)
    ...
    val MathematicianAbnormal = Token(nameResId = R.string.token_abnormal, iconRes = R.drawable.icon_mathematician)
    ...
    val BarberHaircut = Token(nameResId = R.string.token_haircuts, iconRes = R.drawable.icon_barber)

    val EvilTwinTwin = Token(nameResId = R.string.token_twin, iconRes = R.drawable.icon_eviltwin)

    val WitchCursed = Token(nameResId = R.string.token_cursed, iconRes = R.drawable.icon_witch)

    val CerenovusMad = Token(nameResId = R.string.token_mad, iconRes = R.drawable.icon_cerenovus)
